...
using static Bank_Account.Transaction;

namespace Bank_Account
{
    class CreditCard: BankAccount, IBankCard
    {
        ...
        public CreditCard(string accountNo, string accountName, string personID, double cardBalance, double interestRate, double creditLimit, double transactionFee, double anualTax, double cashbackServices) 
