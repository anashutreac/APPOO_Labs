...
%----------------------------------------------------------------------------------------
  ...
  \textsc{\Large Analiza si principiile programarii orientate pe obiect}\\[0.5cm] % Major heading such as course name
...
\newcommand{\HRule}{\rule{\linewidth}{0.5mm}} % Defines a new command for the horizontal lines, change thickness here
  ...
  \vspace{10 mm}
  \HRule \\[0.4cm]
  { \LARGE \bfseries Implementare principielor SOLID  }\\[0.4cm] % Title of your document
  \HRule \\[1.5cm]
  ...
  %----------------------------------------------------------------------------------------
      ...
      Mihail \textsc{Pecari} \\ % Supervisor's Name 
      \emph{lector superior:} \\
      Andrei \textsc{Postaru} % Supervisor's Name
      \end{flushright}
      \end{minipage}\\[4cm]
